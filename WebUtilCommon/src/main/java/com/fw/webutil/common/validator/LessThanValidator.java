...
import com.fw.webutil.common.validator.annotations.LessThan;

public class LessThanValidator implements ICrossFieldValidator<LessThan, Object>
{
	private String lessThanField;
	private Object bean;
	
	@Override
	public void initialize(LessThan matchWith)
	{
