...
import com.fw.webutil.common.validator.annotations.GreaterThanEquals;

public class GreaterThanEqualsValidator implements ICrossFieldValidator<GreaterThanEquals, Object>
{
	private String greaterThanField;
	private Object bean;
	
	@Override
	public void initialize(GreaterThanEquals matchWith)
	{
